...
| `ART_SSO_CLIENT_ID` | Client identifier accepted by the built-in OnlyArt SSO endpoint | - |
| `ART_SSO_CLIENT_SECRET` | Shared secret used only by the OnlyArt backend when exchanging one-time codes | - |
| `ART_SSO_REDIRECT_URIS` | Comma-separated exact OnlyArt callback URLs | - |
