...
func PreConsumeTokenQuota(relayInfo *relaycommon.RelayInfo, quota int) error {
	...
	reserved, err := model.TryReserveTokenQuota(relayInfo.TokenId, relayInfo.TokenKey, quota, relayInfo.TokenUnlimited, relayInfo.ChannelMeta != nil && relayInfo.ChannelType == constant.ChannelTypeRSGateway)
	if err != nil {
		return err
	}
	if !reserved {
